...
\subsection{ejemplo} la ecuación en diferencias
...
\subsection{ejemplo} la siguiente suma: $1^2+2^2+...+n^2$, su fórmula puede obtenerse usando una relación de recurrencia, notando que:
